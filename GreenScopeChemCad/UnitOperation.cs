...
namespace GreenScopeChemCad
{
    ...
    class UnitOperation
    {
        ...
        public UnitOperation(int unitOpID, object vbServer)
        {
            ...
            m_InletStreams = p_Flowsheet.GetInletStreamIDsToUnitOp(unitOpID);
            m_OutletStreams = p_Flowsheet.GetOutletStreamIDsToUnitOp(unitOpID);
        ...
        public double Power
        {
            get
            {
                ...
                else if (m_Category == "TPLS") return (1055.05598654593 / 1000000) * (m_UnitOpSpec[16] + m_UnitOpSpec[17] + m_UnitOpSpec[18] + m_UnitOpSpec[19] + m_UnitOpSpec[20] + m_UnitOpSpec[21] + m_UnitOpSpec[22] + m_UnitOpSpec[23] + m_UnitOpSpec[24] + m_UnitOpSpec[25] + m_UnitOpSpec[26]);//MMBTU/hr
